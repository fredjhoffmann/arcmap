...
import arcpy.da
cost='C:\Users\frederichoffmann\Desktop\ESRI_summer2014\settlements_draft.gdb\costlayer' #cost raster created formerly 
output='C:\Users\frederichoffmann\Desktop\ESRI_summer2014\settlements_draft.gdb\joinabletowns' #table with two columns: one of n and one of m, destination for data that meets criteria
costD='C:\Users\frederichoffmann\Desktop\ESRI_summer2014\settlements_draft.gdb\cost_dist' # costdistance raster 
costB='C:\Users\frederichoffmann\Desktop\ESRI_summer2014\settlements_draft.gdb\cost_backlink' #costbacklink raster 
x=1000 #threshold cost 
n ='arcpy.da.SearchCursor(in_table, field_names)' #of shapefile attribute table (so theidentifier of each polygon) a variable that will move a 
m ='1+[arcpy.da.SearchCursor(in_table, field_names)]' #list of all values for n
